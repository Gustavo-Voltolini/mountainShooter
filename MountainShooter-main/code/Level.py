...
from code.Const import TIMEOUT_LEVEL, TIMEOUT_LEVEL3  # Importe a nova constante

class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        self.timeout = TIMEOUT_LEVEL3 if name == 'Level3' else TIMEOUT_LEVEL  # Ajuste o timeout
        self.window = window
        self.name = name
        ...
        # Configuração de temporizadores para eventos
        pygame.time.set_timer(EVENT_ENEMY, SPAWN_TIME)
        pygame.time.set_timer(EVENT_TIMEOUT, TIMEOUT_STEP)  # 100ms para o contador de tempo
